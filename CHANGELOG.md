...
* Remove unused curl/libcurl and their dependent package-management tools from the runtime image to eliminate the remaining HIGH curl findings; retain CA certificates and RPM metadata for image scanning.
