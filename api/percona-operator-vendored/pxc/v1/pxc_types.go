...
import (
	...
	// VENDORED: Removed imports to internal Percona packages to avoid external dependencies
...
// VENDORED: CheckNSetDefaults method commented out to avoid dependency on version.ServerVersion
// This method is not used by the wandb operator.
// Original signature: func (cr *PerconaXtraDBCluster) CheckNSetDefaults(serverVersion *version.ServerVersion, logger logr.Logger) (err error)
/*
