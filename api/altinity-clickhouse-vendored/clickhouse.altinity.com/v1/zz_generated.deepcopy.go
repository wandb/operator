...
import (
	...
	util "github.com/wandb/operator/api/altinity-clickhouse-vendored/util"
...
func (in *ClickHouseInstallation) DeepCopyInto(out *ClickHouseInstallation) {
	// VENDORED CHANGE: Removed *out = *in to avoid copying mutexes
	...
	// VENDORED CHANGE: Mutexes cannot be copied - they remain zero-valued
