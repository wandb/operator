...
import (
	...
	types "github.com/wandb/operator/api/altinity-clickhouse-vendored/common/types"
...
func (in *ClickHouseInstallation) DeepCopyInto(out *ClickHouseInstallation) {
	// Removed: *out = *in (would copy mutexes)
	...
	// Mutexes cannot be copied - they remain zero-valued
...
func (in *ClickHouseInstallationRuntime) DeepCopyInto(out *ClickHouseInstallationRuntime) {
	// Removed: *out = *in (would copy mutex)
	// ActionPlan interface field is copied
	out.ActionPlan = in.ActionPlan
	if in.attributes != nil {
		in, out := &in.attributes, &out.attributes
		*out = new(ComparableAttributes)
		(*in).DeepCopyInto(*out)
	}
	// Mutex cannot be copied - it remains zero-valued
...
func (in *ClickHouseOperatorConfiguration) DeepCopyInto(out *ClickHouseOperatorConfiguration) {
	// Removed: *out = *in (would copy mutex in Spec)
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
func (in *OperatorConfig) DeepCopyInto(out *OperatorConfig) {
	// Removed: *out = *in (would copy mutex in nested types)
	in.Runtime.DeepCopyInto(&out.Runtime)
...
func (in *OperatorConfigCHI) DeepCopyInto(out *OperatorConfigCHI) {
	// Removed: *out = *in (would copy mutex in Runtime)
	in.Runtime.DeepCopyInto(&out.Runtime)
	return
}
...
func (in *OperatorConfigTemplate) DeepCopyInto(out *OperatorConfigTemplate) {
	// Removed: *out = *in (would copy mutex in CHI)
...
func (in *Status) DeepCopyInto(out *Status) {
	...
	out.CHOpVersion = in.CHOpVersion
	out.CHOpCommit = in.CHOpCommit
	out.CHOpDate = in.CHOpDate
	out.CHOpIP = in.CHOpIP
	out.ClustersCount = in.ClustersCount
	out.ShardsCount = in.ShardsCount
	out.ReplicasCount = in.ReplicasCount
	out.HostsCount = in.HostsCount
	out.Status = in.Status
	out.TaskID = in.TaskID
	out.Action = in.Action
	out.Error = in.Error
	out.HostsUpdatedCount = in.HostsUpdatedCount
	out.HostsAddedCount = in.HostsAddedCount
	out.HostsUnchangedCount = in.HostsUnchangedCount
	out.HostsFailedCount = in.HostsFailedCount
	out.HostsCompletedCount = in.HostsCompletedCount
	out.HostsDeletedCount = in.HostsDeletedCount
	out.HostsDeleteCount = in.HostsDeleteCount
	out.Endpoint = in.Endpoint
	// Complex fields are handled below
