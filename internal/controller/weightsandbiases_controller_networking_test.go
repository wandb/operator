...
var _ = Describe("WeightsAndBiases Networking", func() {
	...
	It("reconciles a consolidated Ingress and mirrors its load balancer status", func() {
		...
		Expect(ingress.Annotations).To(HaveKeyWithValue(apiv2.NginxIngressProxyBodySizeAnnotation, "0"))
		Expect(ingress.Annotations).To(HaveKeyWithValue(apiv2.NginxIngressProxyReadTimeoutAnnotation, "3600"))
		Expect(ingress.Annotations).To(HaveKeyWithValue(apiv2.NginxIngressProxySendTimeoutAnnotation, "3600"))
