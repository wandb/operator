...
func IsRedisInfraError(err error) bool {
	var infraError InfraError
	ok := errors.As(err, &infraError)
	if ok {
		return infraError.infraName == Redis
	}
	return false
}

func IsDatabaseInfraError(err error) bool {
	var infraError InfraError
	ok := errors.As(err, &infraError)
	if ok {
		return infraError.infraName == Database
	}
	return false
}

func IsKafkaInfraError(err error) bool {
	var infraError InfraError
	ok := errors.As(err, &infraError)
	if ok {
		return infraError.infraName == Kafka
	}
	return false
}

func IsClickhouseInfraError(err error) bool {
	var infraError InfraError
	ok := errors.As(err, &infraError)
	if ok {
		return infraError.infraName == Clickhouse
	}
	return false
}

func IsObjStorageInfraError(err error) bool {
	var infraError InfraError
	ok := errors.As(err, &infraError)
	if ok {
		return infraError.infraName == ObjStorage
	}
	return false
}
