...
func summarizeTelemetryConnectionStatus(cfg TelemetryRuntimeConfig) apiv2.TelemetryConnectionStatus {
	...
	return apiv2.TelemetryConnectionStatus{
		...
		MetricsReadEndpoint:   resolvedEndpoints.MetricsReadEndpoint,
		LogsReadEndpoint:      resolvedEndpoints.LogsReadEndpoint,
		TracesReadEndpoint:    resolvedEndpoints.TracesReadEndpoint,
